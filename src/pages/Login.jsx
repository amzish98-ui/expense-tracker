    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 dark:bg-gray-950">
      <div className="w-full max-w-sm rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div className="mb-6 text-center">
          ...
          <h1 className="mt-2 text-xl font-bold text-gray-900 dark:text-gray-50">Welcome back</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Log in to FinDash</p>
        </div>
